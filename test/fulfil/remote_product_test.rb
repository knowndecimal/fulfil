...
module Fulfil
  class RemoteProductTest < Minitest::Test
    def test_from_fulfil_maps_expected_attributes
      ...
      product = RemoteProduct.from_fulfil(raw_product)
